...
\begin{itemize}
	% \item \textbf{If using the N\_breakpoints method:} Multiply the natural mortality age breakpoints and growth Amin (referred to in the control file as ``Age post-settlement\_for\_L1'') and Amax (referred to as ``Growth\_Age\_for\_L2'') values by $1/season duration$.
