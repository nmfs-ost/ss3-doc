...
\begin{itemize}
	\item \textbf{If using the N breakpoints method:} Multiply the natural mortality age breakpoints and growth Amin (referred to in the control file as ``Age post-settlement for L1'') and Amax (referred to as ``Growth Age for L2'') values by 
	% $1/season duration$.
