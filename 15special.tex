...
\begin{figure}[ht]
	...
	\alt{Some examples of time-varying setups.}
...
\begin{figure}[ht]
	\begin{center}
		...
		\alt{Illustration of the jitter algorithm.}
		\label{fig:jitter}
	\end{center}
\end{figure}
...
& P_\text{PRSD} \cdot ln\left(1-\frac{P_\text{init}-P_\text{LB}-0.0001}{P_\text{UB}-P_\text{LB}}\right)
	...
	\begin{figure}[ht]
		...
		\alt{The shape of the symmetric beta prior across alternative standard deviation values and the change in the negative log-likelihood.}
	\end{figure}	
