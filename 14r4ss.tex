\section[Using R To View Model Output (r4ss)]{\protect\hyperref[sec:r4ss]{Using R To View Model Output (r4ss)}}\label{sec:r4ss}
...
%\pagebreak
The core functions available in \gls{r4ss} include:
\begin{center}
