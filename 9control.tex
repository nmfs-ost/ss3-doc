...
\begin{longtable}{p{1cm} p{3cm} p{11cm}}
	...
	\multicolumn{3}{l} \Tstrut\\
	& 4 & Number of hybrid tuning iterations. A value of 2 is OK if fleet switches to parameters; 3 is sufficient with a single fleet and low $F$s; larger values match the catch near exactly when there are many fleets and high $F$. \Bstrut\\
	\hline
