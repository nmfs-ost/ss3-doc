...
\begin{longtable}{p{0.5cm} p{2cm} p{12cm}}
	...
	\Tstrut 1.66 & & Growth Amin (A1): Reference age for first size-at-age parameter. \hyperlink{A1}{\textit{Click here for more information.}}\Bstrut\\
	\hline
...
\begin{longtable}{p{1cm} p{3cm} p{11cm}}
	...
	3 & Spawner-            & The options are: \Tstrut\\
      ...
      & 					& 10(beta): Ricker re-parameterization (3 parameters: log(R0), steepness, and Ricker power, $\gamma$). This SRR is was added to version 3.30.11 and is in beta mode. \hyperlink{Ricker2}{\textit{Click here for more information.}}\Bstrut\\
    \hline
...
\begin{longtable}{p{2cm} p{3cm} p{10cm}}
	...
	4 \Tstrut& 0 & Discontinued: Set size selectivity equal to female fecundity. Use special survey pattern 30 located in the index section within the data file instead.\\
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item 4 = zero reverting random walk with rho. The deviation parameter is now multiplied by the standard error parameter, rather than deviations being penalized accordign to a specified standard error (the approach in v.3.24).
...
\noindent \textbf{Block Trends}:Additional information regarding the options for applying blocks (element 13):
\begin{itemize} 
