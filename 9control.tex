...
\begin{longtable}{p{1cm} p{3cm} p{11cm}}
	...
	1 \Tstrut & Do Recruitment Deviations & This selects the way in which recruitment deviations are coded: \\
	  ...
	  & & 1: Deviation vector (previously the only option): the deviations are encoded as a deviation vector, so ADMB enforces a sum-to-zero constraint, but only in the main period. \\
