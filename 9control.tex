...
Code for the survival based recruitment can be found in \hyperlink{CodeEx}{the code examples} section.
...
%\hypertarget{Shepherd2}{The} Shepherd stock recruit curve re-parameterized version. More details can be found in \citet{punt-extending-2019}.
%	\begin{equation}
...
\begin{longtable}{p{1cm} p{3cm} p{11cm}}
   ...
   \multicolumn{3}{l}{Read list of fleets needing parameters, starting F values, and phases.}\Tstrut\\
   Fleet & Parameter Value & Phase \Tstrutt\\
   1 & 0.05 & 1 \Tstrut\\
   2 & 0.01 & 1 \Tstrut\\
   -9999 & 1  & 1 \Tstrut\\
...
In typical usage:
	\begin{itemize}
		...
		\item  Code for implementing random walk selectivity within SS can be found in \hyperlink{CodeEx}{the code example} section.
	\end{itemize}
...
The exponential logistic included within SS is based on the exponential logistic selectivity detailed by \citet{thompson-confounding-1994}, however, the parameterization within SS differs.  Explorations using this selectivity form has shown that the estimation of p1 can be highly unstable.  Users are strongly encourage to use the double normal selectivity rather than the exponential logistic selectivity.
	\begin{itemize}
...
Code for implementing cubic spline selectivity within SS can be found in \hyperlink{CodeEx}{code examples}.
