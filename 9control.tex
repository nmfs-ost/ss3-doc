...
\begin{longtable}{p{2cm} p{3cm} p{10cm}}
	...
	5 \Tstrut & 2 & \hyperlink{MirrorSelectivity}{Mirror another selectivity}. The two parameters select bin range. \\
	...
	15 \Tstrut & 0 & \hyperlink{MirrorSelectivity}{Mirror another selectivity} (same for age selectivity). \\
...
\begin{longtable}{p{2cm} p{3cm} p{10cm}}
	...
	15 \Tstrut & 0 & \hyperlink{MirrorSelectivity}{Mirror another age-specific selectivity pattern}. \\
