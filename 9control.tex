...
\begin{longtable}{p{1cm} p{3cm} p{11cm}}
   ...
   \multicolumn{3}{l}{Read list of fleets needing parameters, starting F values, and phases. To treat a fleet F as hybrid only select a phase of 99. A parameter line is not required for all fleets except bycatch fleets are required to have an input parameter line.}\Tstrut\\
