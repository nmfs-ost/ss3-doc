...
\begin{longtable}{p{1cm} p{3cm} p{11cm}}
	...
	& 0.10 1 0 & Starting $F$ value, phase, and the number of $F$ detail setup lines to read (example has 0). \\
	...
	\multicolumn{3}{l}{If N for $F$ detail is > 0} \Tstrut\\
	...
	\multicolumn{3}{l}{\multirow{2}{1cm}{\parbox{16cm}{NOTE: In order to invoke reading $F$ details list when using F\_Method = 4, end the list with -9998 instead of -9999 and end the detail list placed AFTER the number of tuning iterations with the following:}}} \Tstrut\\
	& & \\
	\multicolumn{2}{l}{1-9999 1 1 1 1 1} & Fleet, year, season, $F$, \gls{se}, phase - these values override the catch \gls{se} values in the data file and the overall starting $F$ value and phase read just above. \Bstrut\\
