...
\begin{center}
	\begin{longtable}{p{1.25cm} p{1.25cm} p{1cm} p{11.5cm}}
		...
		1 & & \multicolumn{2}{l}{\parbox{12.5cm}{Recruitment distribution method. This section controls which combinations of growth pattern $\times$ area $\times$ settlement timing will get a portion of the total recruitment coming from each annual spawning. Options:}} \Tstrut\\
		& & \\
		% & & \\
