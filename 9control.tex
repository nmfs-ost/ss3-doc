...
Simulation studies conducted by \citet{methot-adjusting-2011} compared three methods of tuning $\sigma_R$ with the above approach generally performed best since it accounts for variability among recruitment deviations and the uncertainty in their estimates. Note that the equation above differs from the 2011 paper in that the standard errors are squared before taking the mean, rather than after, a correction provided by \citet{thorson_status_2015}.
