...
\subsubsection{Catchability Time-Varying Parameters}
...
Code for implementing random walk selectivity can be found in \href{https://github.com/nmfs-ost/ss3-source-code/blob/main/SS_selex.tpl}{\textttSS\_selex.tpl}}, search for ``SS\_Label\_Info\_22.7.17''.
...
When the complete auto-generation is selected, the \verb|control.ss\_new| would look like the table below:	
