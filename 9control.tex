...
\hypertarget{BH-ab}{}
\myparagraph{alpha, beta parameterization of Beverton-Holt}
...
Example setup of the spawner-recruitment section using alpha, beta parameterization of Beverton-Holt:
\begin{center}
	\begin{longtable}{p{1cm} p{1cm} p{1cm} p{1.5cm} p{3cm} p{2cm} p{3.5cm}}
		...
		0.2   & 1  & 0.61  & 0.70 & \multicolumn{1}{c}{...} & 0 & \#SR\_BH\_steep_derived \\
		0.001 & 31 & 0.58  & 10.3 & \multicolumn{1}{c}{...} & 0 & \# SR_BH_ln(alpha) \\
        -30   & 30 & -8.28 & 0.7  & \multicolumn{1}{c}{...} & 0 & \# SR_BH_ln(beta) \\
		0     & 2  & 0.60  & 0.80 & \multicolumn{1}{c}{...} & 0 & \#SR\_sigmaR \\
		-5    & 5  & 0     & 0    & \multicolumn{1}{c}{...} & 0 & \#SR\_regime \\
		-99   & 99 & 0     & 0    & \multicolumn{1}{c}{...} & 0 & \#SR\_autocorr \Bstrut\\
		\hline
