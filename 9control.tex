...
In typical usage:
	\begin{itemize}
		...
		\item  Code for implementing random walk selectivity within SS can be found in online within the  \href{https://github.com/nmfs-stock-synthesis/stock-synthesis/blob/main/SS_selex.tpl}{SS\_selex.tpl}, search for "SS\_Label\_Info\_22.7.17".
	\end{itemize}
