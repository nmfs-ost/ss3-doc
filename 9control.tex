...
How to specify the von Bertalanffy growth function can be found in the \hyperlink{GrowthSpecifications}{table below} listed as option 1.

\myparagraph{Growth Timing} 
...
How to specify the Richards (and Gompertz) growth function can be found in the \hyperlink{GrowthSpecifications}{table below} listed as option 2.
...
How to implement using age-specific K multipliers can be found in the \hyperlink{GrowthSpecifications}{table below} listed as options 3-5.
...
How to use the growth cessation model can be found in the \hyperlink{GrowthSpecifications}{table below} listed as option 8.

\hypertarget{GrowthSpecifications}{}
\vspace*{-\baselineskip}	
\begin{longtable}{p{0.5cm} p{2cm} p{12.5cm}}
	...
	1 & & Growth Model: \Tstrut\\
	  & & 1 = \hyperlink{vonBert}{von Bertalanffy}. This requires 3 parameters (Lmin, Lmax, and the VBK growth coefficient) in the \hyperlink{MGorder}{growth parameter section}; \\
	  & & 2 = \hyperlink{Richards}{Schnute's generalized growth curve (aka Richards curve)} where the \hyperlink{RichardsLine}{Richards coefficient} has null value of 1.0; \\
	  & & 3 = \hyperlink{AgeSpecificK}{von Bertalanffy with age-specific K multipliers} for specified range of ages, requires additional inputs \hyperlink{KSpecificAges}{below} and \hyperlink{AgeSpecificKLines}{parameter lines} for each age following the VBK parameter line in the growth section; \\
	  & & 4 = \hyperlink{AgeSpecificK}{age-specific K}. Set base K as K for age = N ages and working backwards and the age-specific K = K for the next older age * multiplier, requires additional inputs \hyperlink{KSpecificAges4}{below} and \hyperlink{AgeSpecificKLines}{parameter lines} for each age following the VBK parameter line in the growth section; \\
	  & & 5 = \hyperlink{AgeSpecificK}{age specific K}. Set base K as K for N ages and work backwards and the age-specific K = base K * multiplier, requires additional inputs \hyperlink{KSpecificAges5}{below} and \hyperlink{AgeSpecificKLines}{parameter lines} for each age following the VBK parameter line in the growth section; \\
	  & & 6 = not implemented; \\
	  & & 7 = not implemented; and \\
	  & & 8 = \hyperlink{GrowthCessation}{growth cessation}. Decreases the K for older fish. If implemented, the Amin and Amax parameters, the next two lines, need to be set at 0 and 999 respectively. The mortality-growth parameter section requires the \hyperlink{GrowthCessationLines}{base K parameter line} which is interpreted as the steepness of the logistic function that models the reduction in the growth increment by age followed by a second parameter line which is the parameter related to the maximum growth rate. \Bstrut\\
	\hline
...
\begin{longtable}{p{1cm} p{2.25cm} p{10cm}}
	...
	\hypertarget{RichardsLine}{Richards Coefficient} & \multicolumn{2}{l}{Only include this parameter if Richards growth function is used. If included, a parameter value of 1.0 will have a null effect and produce a growth curve identical to von Bertalanffy. To use the Gompertz growth curve, the Richards parameter can be fixed at a small value such as 0.0001.} \\
	           & \multicolumn{2}{l}{0.01 2 1 1 99 0 -4 0 0 0 0 0 0 0 \# Richards\_Fem\_GP\_1} \\
	\multicolumn{2}{l}{COND if growth type >= 3} & \\
	\hypertarget{AgeSpecificKLines}{Age-Specific K} & \multicolumn{2}{l}{N parameter lines equal to the number K deviations for the \hyperlink{KSpecificAges}{ages} specified above.} \Bstrut\\
               & \multicolumn{2}{l}{0.5 3 1 1 1 0 -6 0 0 0 0 0 0 0 \# Age\_K\_mult\_Fem\_GP\_1\_a\_5} \\
               & \multicolumn{2}{l}{0.5 3 1 1 1 0 -6 0 0 0 0 0 0 0 \# Age\_K\_mult\_Fem\_GP\_1\_a\_6} \\
			   & \multicolumn{2}{l}{0.5 3 1 1 1 0 -6 0 0 0 0 0 0 0 \# Age\_K\_mult\_Fem\_GP\_1\_a\_7} \\
    \hypertarget{GrowthCessationLines}{Growth Cessation}  & & \Bstrut\\
	           & \multicolumn{2}{l}{0.1 5 0.271359 1 0 0 -3 0 0 0 0 0 0 0 \# Cessation\_Fem\_GP\_1} \Bstrut\\
	\hline
	...
	\multicolumn{2}{l}{COND if growth type = 2} & \Tstrut\\
	& Richards Coefficient & Only include this parameter if Richards growth function is used in addition to VBK. If included, a parameter value of 1.0 will have a null effect and produce a growth curve identical to Bertalanffy. \\
	\multicolumn{2}{l}{COND if growth type = 3} & \hypertarget{AgeSpecificKLine}{Age-Specific K} \\
