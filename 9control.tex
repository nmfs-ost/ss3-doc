...
\begin{longtable}{p{1cm} p{3cm} p{11cm}}
	...
	0.2 \Tstrut & & F ballpark\\
	    & & This value is compared to the sum of the F’s for the specified year.  The sum is over all seasons and areas.  In older versions of SS, the lambda was automatically set to 0.0 in the final phase, the user now has control over whether to reduce the lambda in later phases (see the \hyperref{Lambdas}{Lambdas} below).\Bstrut\\
   \hline
