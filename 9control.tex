...
\begin{longtable}{p{2cm} p{3cm} p{10cm}}
	...
	1 \Tstrut& 2 & \hyperlink{simple-logistic}{Logistic}. \\
	2 \Tstrut& 6 & \hyperlink{older-selectivity}{Older version of selectivity pattern 24} for backward compatibility in treatment of sex-specific scaling \\
	5 \Tstrut& 2 & \hyperlink{mirror-selectivity}{Mirror another selectivity}. The two parameters select bin range. \\
	6 \Tstrut& 2 + special & \hyperlink{nonparam-selectivity}{Non-parametric} \\
	8 \Tstrut& 8 & \hyperlink{doublelog-selectivity}{Double logistic}, with defined peak, uses smooth joiners; special=1 causes constant selectivity above $L_{inf}$ for morph 1. Recommend using pattern 24 instead. \\
	9 \Tstrut& 6 & \hyperlink{simple-doublelog}{Simple double logistic} with no defined peak. \\
	11 \Tstrut& 2 & \hyperlink{selectivity1}{Selectivity = 1.0} for a specified length-bin range. \\
	15 \Tstrut& 0 & \hyperlink{mirror}{Mirror} another selectivity (same as for age selectivity). \\
	21 \Tstrut& 2 & Non-parametric size selectivity \\
	22 \Tstrut& 4 & \hyperlink{doublenorm-plateau}{Double normal}; similar to CASAL. \\
	23 \Tstrut& 6 & Same as the double normal pattern 24 except the \hyperlink{doublenorm-peak-tail}{final selectivity is now directly interpreted as the terminal selectivity value}. Cannot be used with Pope's F method because maximum selectivity may be greater than 1. \\
	24 \Tstrut& 6 & \hyperlink{doublenorm-peak-tail}{Double normal with defined initial and final selectivity level} - Recommended option. \\
	25 \Tstrut& 3 & \hyperlink{exponential-log}{Exponential-logistic}. \\
	27 \Tstrut& 3 + 2*N nodes & \hyperlink{cubic-spline}{Cubic spline} with N nodes. \\
	42 \Tstrut& 5 + 2*x & Selectivity pattern 27 but with \hyperlink{spline-scaling}{2 additional scaling parameters}. \\
	43 \Tstrut& 4 + x & Selectivity pattern 6 but with \hyperlink{nonparam-scaling}{2 additional scaling parameters}. \Bstrut\\
	\hline
\end{longtable}
...
\begin{longtable}{p{2cm} p{3cm} p{10cm}}
	...
	11 \Tstrut& 2 & \hyperlink{selectivity1}{Selectivity = 1.0} for a specified age range. \\
	12 \Tstrut& 2 & \hyperlink{simple-logistic}{Logistic}. \\
	13 \Tstrut& 8 & Double logistic, IF joiners. Use discouraged. Use pattern 18 instead. \\
	14 \Tstrut& nages + 1 & \hyperlink{revise-age}{Separate parameter for each age} (empirical), value at age is $\frac{1}{1+exp(-x)}$. \\
	15 \Tstrut& 0 & \hyperlink{mirror}{Mirror} another age-specific selectivity pattern. \\
	16 \Tstrut& 2 & \hyperlink{gaussian}{Coleraine single Gaussian}. \\
	17 \Tstrut& nages + 1 or special + 1 & Empirical as a \hyperlink{random-walk}{random walk} from previous age. \\
	18 \Tstrut& 8 & \hyperlink{doublelog-selectivity}{Double logistic}, with defined peak, uses smooth joiners. \\
	19 \Tstrut& 6 & \hyperlink{simple-doublelog}{Simple double logistic} with no defined peak. \\
	20 \Tstrut& 6 & \hyperlink{doublenorm-peak-tail}{Double normal with defined initial and final level} - Recommended option. \\
	26 \Tstrut& 3 & \hyperlink{exponential-log}{Exponential logistic}. \\
	27 \Tstrut& 3 + 2*N nodes & \hyperlink{cubic-spline}{Cubic spline} in age based on N nodes. \\
	41 \Tstrut& 2 + nages + 1 & Selectivity pattern 17 but with \hyperlink{walk-scaling}{2 additional scaling parameters}. \\
	42 \Tstrut& 5 + 2*N nodes & Selectivity pattern 27 but with \hyperlink{spline-scaling}{2 additional scaling parameters}. \\
	44 \Tstrut& 4 + nages & Similar to age selectivity pattern 17 but with \hyperlink{walk-log}{separate parameters for males and with revised controls}. \\
	45 \Tstrut& 4 + nages & Similar to age selectivity pattern 14 but with \hyperlink{revise-age}{separate parameters for males and with revised controls}. \Bstrut\\
	\hline
\end{longtable}
...
\hypertarget{mirror-selectivity}{}
...
\hypertarget{nonparam-selectivity}{}
...
\hypertarget{doublelog-selectivity}{}
...
\begin{longtable}{p{4cm} p{0.9cm} p{0.9cm} p{0.9cm} p{0.9cm} p{0.9cm} p{0.9cm} p{0.9cm} p{0.9cm}}
	\hline	
	Population Length Bin \#  & 1 & 2 & 3 & 4 & 5 & 6 & 7 & 8 \Tstrut\\
...
\hypertarget{doublenorm-plateau}{}
...
\hypertarget{doublenorm-peak-tail}{}
...
Similar to pattern 14 but with separate parameters for males and females. Age-selectivity pattern 45 allows selectivity-at-age to be the same as selectivity at the next younger age.
	\begin{itemize}
