...
\begin{itemize}
	...
	\item For each source area, the implicit movement parameter value is 0.0. However, this default value is replaced if the stay movement is selected to have an explicit pair of parameters (e.g., specify movement rate for area 1 to area 1).
