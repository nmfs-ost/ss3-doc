...
\begin{longtable}{p{0.5cm} p{2cm} p{12.5cm}}
		...
		3 \Tstrut & & \multirow{2}{12.5cm}[-0.1cm]{\parbox{12.5cm}{Number of block patterns. These patterns can be referred to in the parameter sections to create a separate parameter value for each block.}} \Bstrut\\
		\\
		...
		& \multirow{3}{2cm}[-0.1cm]{1975 1985 1986 1990 1995 2001} & \multirow{3}{12.5cm}[-0.1cm]{Beginning and ending years for blocks in design 1; years not assigned to a block period retain the baseline value for a parameter that uses this pattern.} \Bstrut\\
		\\
		\Bstrut\\
		% \\
		& \multirow{2}{2cm}[-0.1cm]{1987 1990 1995 2001} & \multirow{2}{12.5cm}[-0.1cm]{Beginning and ending years for blocks in design 2.} \Bstrut\\
		\\
		% \\
