...
These listed model features are denoted in the control file in the following order:
	\begin{enumerate}
		...
		\item Recruitment distribution parameters for each area, settlement event, growth pattern
...
\begin{longtable}{p{0.5cm} p{2cm} p{12cm}}
	...
	\multicolumn{2}{l}{0 0 0 0 0} & Five values control auto-generation for: 1-biology, 2-spawn-recruitment, 3-catchability, 4-tag (future), 5-selectivity.\\
...
\begin{longtable}{p{0.5cm} p{2cm} p{12.75cm}}
	...
	\multicolumn{2}{l}{COND = 3 or 4} \Tstrut & Do not read any natural mortality parameters.  With option 3, these M values are held fixed for the integer age (no seasonality or birth season considerations). With option 4, there is seasonal interpolation based on real age, just as in options 1 and 2.\\
...
\begin{longtable}{p{1cm} p{1cm} p{1cm}  p{1.5cm}  p{2.9cm}  p{1.5cm}  p{4.5cm} }
	...
	-10 & 10 & 9 & 9 & \multicolumn{1}{c}{...} & 0 & \#TG loss chronic3\\
	  1 & 10 & 2 & 2 & \multicolumn{1}{c}{...} & 0 & \#TG loss overdispersion1\\
	  1 & 10 & 2 & 2 & \multicolumn{1}{c}{...} & 0 & \#TG loss overdispersion2\\
	  1 & 10 & 2 & 2 & \multicolumn{1}{c}{...} & 0 & \#TG loss overdispersion3\\
