...
\begin{longtable}{p{1cm} p{3cm} p{11cm}}
	...
	\multicolumn{3}{l}{\multirow{2}{1cm}{\parbox{16cm}{NOTE: In order to invoke reading F details list when using F\_Method = 4, end the list with -9998 instead of -9999 and end the detail list with the following:}}} \Tstrut\\
	& & \\
