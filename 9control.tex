...
Note that juvenile natural mortality and first mature length of fish inputs are by sex (and growth pattern), but they may be implemented in the future so that parameters can be shared across sex.
