...
\begin{longtable}{p{4.5cm} p{10cm}}
	...
	\multicolumn{1}{l}{3} & Number of ages with a K deviation; \\
	\multicolumn{1}{l}{2 4 6} & Vector of ages with a K deviation \\
	\hline
...
\begin{verbatim}
LO   HI   INIT    PRIOR PR_SD PR_type PHASE ... Block Block_Fxn 
10   45   21.6597 36    10    6       -2        0     0          # L_at_Amin_Fem_GP_1
40   90   71.6551 70    10    6       -4        0     0          # L_at_Amax_Fem_GP_1
0.05 0.25 0.14723 0.15  0.8   6       -4        0     0          # VonBert_K_Fem_GP_1
\end{verbatim}
...
40   90   71.6551 70    10    6       -4        0     0          # L_at_Amax_Fem_GP_1
0.05 0.25 0.14723 0.15  0.8   6       -4        0     0          # VonBert_K_Fem_GP_1
0.01 2    1       1     99    0       -4        0     0          # Richards_Fem_GP_1
\end{verbatim}
...
40   90   71.6551 70    10    6       -4        0     0          # L_at_Amax_Fem_GP_1
0.05 0.25 0.14723 0.15  0.8   6       -4        0     0          # VonBert_K_Fem_GP_1
0.5  3    1       1     1     0       -6        0     0          # Age_K_mult_Fem_GP_1_a_2
0.5  3    1       1     1     0       -6        0     0          # Age_K_mult_Fem_GP_1_a_3
0.5  3    1       1     1     0       -6        0     0          # Age_K_mult_Fem_GP_1_a_4
\end{verbatim}

\hypertarget{GrowthCessation}{}
\mysubparagraph{Growth cessation}
A growth cessation model was developed for the application to tropical tuna species (Maunder et al., 2018). Growth cessation allows for a linear growth for the youngest individuals, then a logistic function to model the decreasing growth rate at older ages, typically after the onset of sexual maturity.  

The parameter roles are not named exactly as the generic names shown in SS3 output. The four parameters are:
...
\begin{enumerate}
	...
	\item $r_{max}$ (labelled as VonBert\_K) is the linear growth rate beginning at age 0 and;
...
40   90   71.6551 70    10    6       -4        0     0          # L_at_Amax_Fem_GP_1
0.05 0.25 0.14723 0.15  0.8   6       -4        0     0          # VonBert_K_Fem_GP_1
0.1  5    0.27135 1     0     0       -3        0     0          # Cessation_Fem_GP_1
\end{verbatim}
