...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item This column was previously called "Use Deviation". Previously available options in SS v.3.24 for comparison were:
		\begin{itemize}
			\item 1: multiplicative
			\item 2: additive
	...
	\item Deviation Phase - Element 12 in parameter setup
		\begin{itemize}
			...
			\item This column was previously called "Deviation Standard Error". Previously available option in SS v.3.24, for comparison was:
			\begin{itemize}
