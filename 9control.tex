...
\begin{longtable}{p{1.5cm} p{14cm}}
	...
	1 & Growth model selection (see available options in the \hyperlink{GrowthModelOptions}{Growth model options table} below)
	\hline
	...
	0.20 & Exponential decay for growth within plus group (see the \hyperlink{ExponentialDecay}{Exponential decay section} below for options)
	\hline
	...
	1 & CV Pattern. The four options explained in the \hyperlink{CVPattern}{CV Pattern section} below. \\
	\hline
