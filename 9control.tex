...
\noindent Code for implementing vectors of mean age and standard deviation of age within SS can be located in \hyperlink{AgeingError}{the code examples} on page \pageref{sec:codeappendix}.
...
\begin{longtable}{p{1cm} p{3cm} p{11cm}}
	...
	3 & Spawner-            & The options are: \Tstrut\\
	  & Recruitment         & 2: Ricker: 2 parameters: ln(R0) and steepness (h); \\
	  & Relationship        & 3: Standard Beverton-Holt, 2 parameters: ln(R0) and steepness; \\
