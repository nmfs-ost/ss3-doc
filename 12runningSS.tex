...
\begin{enumerate}
  \item Find the correct version of the SS.exe binary on your computer (or download from the \href{https://github.com/nmfs-stock-synthesis/ss3-source-code/releases}{SS3 releases}).
