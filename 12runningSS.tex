...
As of ADMB 12.3, a new command called ``-hess\_step'' is available to use and documented in the \hyperlink{hess-step}{Using -hess\_step to do single Newton steps using the inverse Hessian}
...
\subsubsection{Using -hess\_step to do single Newton steps using the inverse Hessian}
