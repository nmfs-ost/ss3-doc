...
As of ADMB 12.3, a new command called "-hess_step" is available to use and documented in the \hyperlink{hess-step}{Using -hess_step to do additional Newton steps using the inverse Hessian}
...
\subsubsection{Using -hess_step to do additional Newton steps using the inverse Hessian}
