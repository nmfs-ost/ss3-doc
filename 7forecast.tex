...
\subsection{Forecast File Options (forecast.ss)}	
 ...
 %   & & \\
  ...
  Option 1: & \multicolumn{2}{l}{\multirow{1}{1cm}[-0.15cm]{\parbox{18cm}{This approach for forecast year ranges is no longer recommended because blocks, random effects, and other time-varying parameter changes can now operate on forecast years.}}} \Tstrut\\
   & & \\

  % \pagebreak
  0 0 0 0 0 0 & Enter 6 Forecast Year Values & \multirow{1}{1cm}[-0.15cm]{\parbox{11.3cm}{To continue to use this pre-SS3.20.22 approach, enter 6 values: beginning and ending years for selectivity, relative Fs, and recruitment distribution. These will be used to create averages over the specified range of years. These can be entered in as the actual year, -999 for start year, or values of 0 or -integer to be relative endyr.}} \Bstrut\\
   & & \\
   & & \\
   & & \\
   & & Important things to note:\\
   & & - Relative F for bycatch only fleets is scaled just like other fleets.\Tstrut\\
   & & \multirow{1}{1cm}[-0.15cm]{\parbox{11.3cm}{- For selectivity averaging with the new approach the method code is ``1'', whereas with the old Forecast Selectivity Option approach, the code was ``1'' for using time-varying parameters. SS3 accounts for this change internally.}} \Tstrut\\
   & & \\
   & & \Bstrut\\
  ...
  % \hline
  Option 2: & \multicolumn{2}{l}{\multirow{1}{1cm}[-0.15cm]{\parbox{18cm}{To invoke use of the new approach, enter a single value of -12345 and also omit entry of the \hyperlink{FcastSelectivity}{Forecast Selectivity Option}.}}} \\
   & & \\
  ...
  \multicolumn{2}{l}{Example New Forecast Format Input:} & \\
   & Method \hspace{15mm} Start Year & End Year \\
  10 & 1 \hspace{26mm} 0 & 0 \hspace{30mm} \# selectivity \\
  11 & 1 \hspace{26mm} -3 & 0 \hspace{30mm} \# rel\_F\\
  12 & 1 \hspace{26mm} 2006 & 2014 \hspace{24mm} \# recruitment\\
  -9999 & -1 \hspace{25mm} -1 & -1 \Bstrut\\

  \hline
   & 1 = M; & \multirow{1}{1cm}[-0.15cm]{\parbox{11.3cm}{These are what has been implemented thus far. Terminate with -9999.}} \Tstrut\\
  ...
  \hline
   ...
   & Start Year & Enter the actual year or values of 0 or -integer to be relative styr. \\
