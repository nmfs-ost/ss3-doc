...
\subsection{Forecast File Options (forecast.ss)}	
 ...
 1 & MSY units &  \\
   ...
   & 3 = profits. &  \\
 \multicolumn{1}{r}{1 0 1}  & Fleet, Cost/F, Price/mt & \multirow{1}{1cm}[-0.1cm]{\parbox{11cm}{To calculate F\textsubscript{MEY} enter fleet number, the cost/F, and price per mt. Care should taken when scaling the values used for cost/F and price/mt. Units in the example show cost=0 and price = 1, so will be identical to MSY in weight.}}  \\
 \multicolumn{1}{r}{2 0 1}  &  &   \\
 \multicolumn{1}{r}{-9999 1 1 } & Terminator line & \Bstrut\\
