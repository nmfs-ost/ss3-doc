...
\subsection{Forecast File Options (forecast.ss)}	
 ...
 %   & & \\
  ...
  \hline
  -12345 & Invoke New Forecast Format & \multirow{1}{1cm}[-0.15cm]{\parbox{11cm}{Biology and selectivity vectors will be updated annually in the forecast according to the time-varying parameters. Be sure to check the end year of the blocks and the deviation vectors. Input in this section directs the creation of averages over historical years to override any time-varying changes.}} \Tstrut\Bstrut\\
   & & \\
   & & \\
   & & \\
  ...
  MG\_type & Method \hspace{15mm} Start Year & End Year \\
  ...
  \hline
   & MG Type & \multirow{1}{1cm}[-0.15cm]{\parbox{11cm}{These are the MG types implemented thus far. Terminate with -9999 for MG type.}} \Tstrut\\
   & 1 = M; & \\
