...
The specification of options for forecasts is contained in the mandatory input file named forecast.ss.  See \hyperlink{sec:forecast}{Forecast Module: Benchmark and Forecasting Calculations} for additional details. 
