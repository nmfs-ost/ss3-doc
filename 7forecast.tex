...
\subsection{Forecast File Options (forecast.ss)}	
 ...
 \hline 
 \multicolumn{3}{l}{COND: Do Benchmark = 3}\Tstrut\\
     & -0.25 & B\textsubscript{LIMIT} as a fraction of the B\textsubscript{MSY} where a negative value will be applied as a fraction of B0 \\
     &       & \Bstrut\\
