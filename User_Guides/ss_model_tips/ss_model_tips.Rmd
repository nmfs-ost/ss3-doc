...
1. Find an existing working model (perhaps one of the SS3 example models available in the [ss3-user-examples repository](https://github.com/nmfs-stock-synthesis/ss3-user-examples) or perhaps a model more similar in form to the model you plan to create).
...
The [SS3 user manual](https://github.com/nmfs-stock-synthesis/ss3-doc/releases) can be used as a guide to help you edit your model. Conditional inputs are noted in the manual. The SSI can also help guide you through changes in model inputs required as you select different SS3 model options.
