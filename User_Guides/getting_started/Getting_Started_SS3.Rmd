...
+ **Stock Assessment Continuum Tool**: Available through github at https://github.com/shcaba/SS-DL-tool, the Stock Assessment Continuum Tool (previously known as the Stock Synthesis Data-limited Tool) provides an Shiny application interface upload catch time series, age composition, length composition, and abundance index data and then define model options within the Shiny application, rather than in the Stock Synthesis input files.
