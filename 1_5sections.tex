		...
		\begin{center}
			\begin{longtable}{p{2cm} p{3cm} p{10cm}}
				...
				General & 
				  ...
				  \\
				  & \hyperlink{WAAparm} {Empirical Weight-at-Age} & Implementing empirical weight-at-age is now specified specifically in the control file rather than under the maturity options.\\
				\hline
				Fishery and Catch & 
