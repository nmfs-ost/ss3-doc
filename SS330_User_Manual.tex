...
\usepackage[tagged, highstructure]{accessibility} % Alt text option for figures
\usepackage{axessibility} % Accessibility for mathematical formulae
...
\begin{document}
	...
	\begin{figure}[ht]
	    ...
	    \end{center}
		\alt{Logo of the National Oceanic and Atmospheric Administration (NOAA)}
