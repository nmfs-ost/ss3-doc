...
\usepackage{booktabs}
\usepackage{fontspec}
% \usepackage{lmodern} #copilot said to remove
% \usepackage[none]{hyphenat}
\usepackage{array}
% \usepackage{lscape}
\usepackage{pdflscape}
\usepackage{longtable}
% \usepackage[utf8]{inputenc} #copilot said remove
...
\title{\textcolor[cmyk]{1.00,0.83,0.41,0.36}{Stock Synthesis User Manual\\ Version 3.30.23.2}}
