...
\begin{longtable}{p{3cm} p{7cm} p{11cm}} 
 ...
 \hypertarget{ALK}{0} & Age-length-key (ALK) tolerance level, value 0 or greater & Value of 0 will not apply any compression.  Values > 0 (e.g. 0.0001) will apply compression to the ALK which will increase the speed of calculations.  
