...
%  \pagebreak
 ...
 %\pagebreak
 \hline
 \multicolumn{1}{r}{1940 1950} & \multirow{2}{1cm}[-0.25cm]{\parbox{19.5cm}{Vector of years for additional \gls{sd} reporting. The number of years needs to equal the value specified in the above line (Extra \gls{sd} Report Years).}} \\
  & & \\
