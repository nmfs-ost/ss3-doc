...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale = 0.5]{appendixB_McAllister_Ianelli}\\
	\end{center}

	\caption{ Input N vs. Effective N comparison, Length composition data as plotted by r4ss.}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale = 0.10]{appendixB_Francis}\\
	\end{center}
	\caption{Mean length for Fleet1 with 95\% confidence intervals based on current samples sizes. Francis data weighting method TA1.8: thinner intervals (with capped ends) show result of further adjusting sample sizes based on suggested multiplier (with 95\% interval) for len data from Fleet1: 0.2739 (0.1661-0.6305).}
	\label{fig:francis}
	%\figurename{name}
\end{figure}
