...
\begin{longtable}{p{1cm} p{3cm} p{11cm}}
	...
	\endlastfoot
		...
		&   & This lambda is for the logL of the forecast recruitment deviations that occur before endyr + 1.  Use a larger value here if solitary, noisy data at end of time series cause unruly recruitment deviation estimation. Default:  1.0 \\
...
\begin{center}
	\begin{longtable}{p{1.1cm} p{1.1cm} p{1.2cm} p{1.2cm} p{1.5cm} p{1.1cm} p{1.5cm} p{4.3cm}}
		...
		\#LO & HI & INIT & PRIOR & PR SD & ... & BLOCK FXN & LABEL \\
		\hline
		1    & 25 & 1 & 1 & 10 & ...  & 0   & \#ln(EffN\_mult)\_1 Dirichlet\\
		\hline
	\end{longtable}
\end{center} 
