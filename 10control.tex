...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item 3 = Q with power, 2 parameters establish a parameter for non-linearity in survey-abundance linkage.  Assumes proportional with offset and power function: $y=qx^c$.
	\end{enumerate}
...
A new experimental feature added within SS v. 3.30.03.02.  Earlier versions do not have this feature and hence this input is not expected.
\begin{center}
	\begin{longtable}{p{2cm} p{4cm} p{6cm}}
		Value & Label & Description \\
		\hline
		0 & 2D AR1 selectivity & 0 = not used \\
		  &  & 1 = use\\
		\hline
	\end{longtable}
\end{center}
