...
\begin{itemize}
  ...
  \item For more information on the implementation of time-varying parameters, see that section at:  xxxx
\end{itemize}	
...
\begin{longtable}{p{0.5cm} p{2cm} p{12cm}}
	 \hline
	 \\
     \multicolumn{3}{l}{Controls for all time-varying  parameters}\\
     \hline
