...
\textbf{Special Selectivity Options}: 
Special selectivity options (type 30 and above) are no longer
specified within the control file. Specifying the use of
one of these selectivity types is now done within the
data file by selecting the survey "units" (see the section 
on \hyperlink{GenericFleets}{Index units}).
