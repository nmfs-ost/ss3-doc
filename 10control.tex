...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item 3 = Q with power, 2 parameters establish a parameter for non-linearity in survey-abundance linkage.
	\end{enumerate}
...
\begin{center}
	\begin{longtable}{p{2.75cm} p{2.75cm} p{2.75cm} p{2cm} p{2cm} p{2cm}}
		...
		\endfoot
		\endlastfoot
	    \#Link Type & Extra Input & Extra SD & Bias Adjust & Q Float  & Fleet \\
	    \hline
	    1 & 0 & 1 & 0 & 0 & \#Fishery 1 \\
	    1 & 0 & 1 & 0 & 0 & \#Fishery 2 \\
	    1 & 0 & 0 & 0 & 0 & \#Survey 1 \\
