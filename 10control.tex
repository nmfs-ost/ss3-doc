...
\begin{center}
	\begin{tabular}{p{2cm} p{3cm} p{10cm}}
		...
		6 & PRIOR TYPE  & 0 = none, 1 = symmetric beta, 2 = full beta, 3 = lognormal with bias adjustment, , 4 = normal, 5 = gamma\\
...
\begin{center}
	...
	\begin{longtable}{p{0.5cm} p{2cm} p{12cm}}
		...
		0 & & 0 = do not read the wtatage.ss file \\
		  ...
		  & & See section \hyperlink{WAA}{\textit{Empirical Wt-at-Age}} for details.\\
		\hline
