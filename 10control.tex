...
\end{center}
	...
	In SS3.30, several cahnges are introduced to the implementation of timevarying parameters.
\begin{itemize}
  ...
  \item the block feature that allowed input of one block parameter line and replication of that line by SS as oten as needed has been replaced.  Now there is a complete timevary parameter autogeneration capability.
...
\begin{center}
	\begin{longtable}{p{0.5cm} p{2cm} p{12cm}}
     ...
     \hline
		...
		\\ \\ \\
		0 & & \multirow{1}{6cm}[-0.1cm]{\parbox{12cm}{where 0 means to autogenerate all time-varying parameters; 1 means to read each time-varying parameter line}}
	\end{longtable}
\end{center}
