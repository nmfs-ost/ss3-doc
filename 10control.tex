...
These listed model features are denoted in the control file in the following order:
	\begin{enumerate}
		...
		\item Environmental effects on R0, steepness, and annual deviations
		\item Block or trend effects on R0, steepness, and annual deviations
		...
		\item Time-varying Q parameters
		\\
...
\begin{center}
	\begin{tabular}{p{2cm} p{3cm} p{10cm}}
		...
		5 & PRIOR TYPE  & 0 = none, 1 = symmetric beta, 2 = full beta, 3 = lognormal with bias adjustment, 5 = gamma, 6 = normal\\
		...
		9  & Dev Link & Invokes use of the deviation vector in the the linkage function \\
		...
		13 & Block & Specify time block to be applied \\
...
\begin{center}
	...
	\begin{longtable}{p{0.5cm} p{2cm} p{12cm}}
		...
		\multicolumn{2}{l}{1 1 1 0}& \multicolumn{1}{l}{\multirow{1}{12cm}[-0.1cm]{\parbox{12.5cm}{Recruitment assignment to GP, month, area, and age (for each settlement event).}}}\\
		\\
		\hline	
...
\begin{center}
	\begin{longtable}{ p{0.7cm} p{0.7cm} p{0.7cm}  p{1cm}  p{1.4cm}  p{1cm} p{1cm} p{6.7cm}  }
		...
		-99   & 99  & 1 & 0 & -1 & 0 & -1 &\#Wtlen\_1\_Fem\_ENV\_add\\
		-99   & 99  & 1 & 0 & -1 & 0 & -1 &\#Wtlen\_2\_Fem\_ENV\_add\\
		\hline
	\end{longtable}
\end{center}
...
\hypertarget{SRR}{text} % this line causes the file to say "text" which maybe isn't the intent
...
\begin{center}
	\begin{longtable}{p{1cm} p{1cm} p{1cm}  p{1.5cm}  p{2.5cm}  p{1.5cm}  p{4.5cm}  }
		...
		-5   & 5  & 0    & 0    & ... & 0 & \#SR\_nullparm \\
		-5   & 5  & 0    & 0    & ... & 0 & \#SR\_R1\_offset\\
...
\begin{center}
	\begin{longtable}{p{1cm} p{1cm} p{1cm} p{1.2cm} p{1.2cm} p{1.1cm} p{1.5cm} p{5.2cm}}
		...
		\hline
		0.001 & 2    & 0.079 & 0.079 & 0.5   & 6       & -5   & \#LnQ\_base\_Survey\_dev\_se\\
		-0.99 & 0.99 & 0.00  & 0.00  & 0.5   & 6       & -6   &  \#LnQ\_base\_Survey\_dev\_se\\
		\hline
	\end{longtable}
\end{center}
...
\begin{center}
	\begin{longtable}{p{0.8cm} p{0.8cm} p{1cm} p{0.8cm} p{1.75cm}p{1cm} p{1.2cm} p{5.2cm}}
		...
		\hline
		0.01 & 2.0 & 0.58 & 0.58 &  0.5  & 6 & -5 & \#AgeSel\_P4\_Fishery\_dev\_se \\
		1    & 80  & 70   & 70   &  0.5  & 6 & -5 & \#AgeSel\_P4\_Fishery\_dev\_autocorr \\
		\hline
	\end{longtable}
\end{center}
...
\begin{center}
	\begin{longtable}{p{0.75cm} p{0.75cm} p{0.75cm} p{1.25cm} p{1.15cm} p{1.65cm} p{1.5cm} p{0.75cm} p{4.5cm}}
		...
		\hline
		-10 & 10 & 9 & 9 & 0.001 & 6 & -4 & 0 & \#TG loss init 1\\
		-10 & 10 & 9 & 9 & 0.001 & 6 & -4 & 0 & \#TG loss init 2\\
		-10 & 10 & 9 & 9 & 0.001 & 6 & -4 & 0 & \#TG loss init 3\\
		-10 & 10 & 9 & 9 & 0.001 & 6 & -4 & 0 & \#TG loss chronic1\\
		-10 & 10 & 9 & 9 & 0.001 & 6 & -4 & 0 & \#TG loss chronic2\\
		-10 & 10 & 9 & 9 & 0.001 & 6 & -4 & 0 & \#TG loss chronic3\\
		  1 & 10 & 2 & 2 & 0.001 & 6 & -4 & 0 & \#TG loss overdisperion1\\
		  1 & 10 & 2 & 2 & 0.001 & 6 & -4 & 0 & \#TG loss overdisperion2\\
		  1 & 10 & 2 & 2 & 0.001 & 6 & -4 & 0 & \#TG loss overdisperion3\\
		-10 & 10 & 9 & 9 & 0.001 & 6 & -4 & 0 & \#TG report fleet1\\
		-10 & 10 & 9 & 9 & 0.001 & 6 & -4 & 0 & \#TG report fleet2\\
