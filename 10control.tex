...
\begin{center}
	\begin{longtable}{p{2cm} p{3cm} p{10cm}}
		...
		42 & 5 + 2*N nodes & Selectivity pattern 27 with user-defined scaling \\
		44 & nages + 4 & Similar to age selectivity option 17 but with separate parameters for males and with revised controls \\
		44 & nages + 4 & Similar to age selectivity option 14 but with separate parameters for males and with revised controls \\
		\hline
	\end{longtable}
\end{center}
