...
\begin{center}
	\begin{longtable}{p{1.1cm} p{1.1cm} p{1.2cm} p{1.2cm} p{1.5cm} p{1.1cm} p{1.5cm} p{4.3cm}}
		...
		0.001 & 2   & 0.079 & 0.079 & -1 & ...  & 0   & \#Survey1 LnQ base\\
...
\begin{description}
	...
	\begin{center}
		\begin{longtable}{p{0.8cm} p{0.8cm} p{1cm} p{0.8cm} p{1.75cm} p{1cm} p{1cm} p{1cm} p{4.2cm}}
			\#LO & HI & INIT & PR & PR\_TYPE & SD & PHASE &  ... & \# Label \\
			\hline
			0 & 20 & 10 & 0 & -1 & 0 & -99 & 0 & \# AgeSel\_ScaleAgeLo \\
			0 & 20 & 20 & 0 & -1 & 0 & -99 & 0 & \# AgeSel\_ScaleAgeHi \\
			\hline
		\end{longtable}
	\end{center}
\end{description}
...
\begin{description}
	...
	\begin{center}
		\begin{longtable}{p{0.7cm} p{0.7cm} p{0.9cm} p{0.7cm} p{1.75cm} p{1cm} p{1cm} p{1cm} p{4.7cm}}
		\#LO & HI & INIT & PR & PR\_TYPE & SD & PHASE &  ... & \# Label \\
		\hline
		0 & 20 & 10 & 0 & -1 & 0 & -99 & 0 & \# AgeSpline\_ScaleAgeLo \\
		0 & 20 & 20 & 0 & -1 & 0 & -99 & 0 & \# AgeSpline\_ScaleAgeHi \\
		\hline
		\end{longtable}
	\end{center}
\end{description}
...
\begin{description}
	...
	\begin{center}
		\begin{longtable}{p{0.8cm} p{0.8cm} p{1cm} p{0.8cm} p{1.75cm} p{1cm} p{1cm} p{1cm} p{4.2cm}}
			\#LO & HI & INIT & PR & PR\_TYPE & SD & PHASE &  ... & \# Label \\
			\hline
			1 & 80 & 50 & 0 & -1 & 0 & -99 & 0 & \# SizeSel\_ScaleBinLo \\
			1 & 80 & 70 & 0 & -1 & 0 & -99 & 0 & \# SizeSel\_ScaleBinHi \\
			\hline
		\end{longtable}
	\end{center}
\end{description}
