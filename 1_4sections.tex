...
\section{File Organization}\label{FileOrganization}		
	...
	\begin{enumerate}
		...
		\item ss3.par (previously ss.par): previously created parameter file that can be read to overwrite the initial parameter values in the control file (optional)
