...
\section[Introduction]{Introduction \protect\hyperref[sec:intro]{\faExternalLink}}\label{sec:intro}
...
\hypertarget{cite}{}
\subsection[How to Cite]{How To Cite \protect\hyperlink{cite}{\faExternalLink}}
...
\section[File Organization]{File Organization \protect\hyperref[sec:FileOrganization]{\faExternalLink}}\label{sec:FileOrganization}
	\hypertarget{input-files}{}
	\subsection[Input Files]{Input Files \protect\hyperlink{input-files}{\faExternalLink}}
	\begin{enumerate}
		...
		\item profilevalues.ss: File containing special conditions for batch file processing (optional)
	\end{enumerate}
	
	\hypertarget{output-files}{}
	\subsection[Output Files]{Output Files \protect\hyperlink{output-files}{\faExternalLink}}
	\begin{enumerate}
...
\section[Starting Stock Synthesis]{Starting Stock Synthesis \protect\hyperref[sec:StartSS3]{\faExternalLink}}\label{sec:StartSS3}
