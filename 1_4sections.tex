...
\section[File Organiztion]{\protect\hyperref[FileOrganization]{File Organization}}\label{FileOrganization}
	...
	\subsection[Output Files]{\protect\hyperlink{OutputFiles}{Output Files}}
	\begin{enumerate}
