...
\subsection{Time Units}
	\begin{itemize}
		\item Spawning: 
		\begin{itemize}
			\item Restricted to happening once per year at a specified date (in real months, 1.0 - 12.99). To create multiple spawning events per year, change the definition of a year (e.g. call a 6 month period a "year" when there are two spawning events about 6 months apart) which you can do by having the total duration of the seasons be less than 1 year. 
		\end{itemize}
