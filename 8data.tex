...
\myparagraph{Note}
	\begin{itemize}
		...
		\item Bin boundaries do not need to align with the population length bin boundaries. SS interpolates as necessary.
