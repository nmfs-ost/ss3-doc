...
The options for units for input data are:	
	\begin{itemize}
		...
		\begin{itemize}
			...
			\begin{itemize}
				\item Special survey option 34 automatically adjusts phases of parameters.  There are options for additional control over this in the control file Q setup section under the link information column where:
				\begin{itemize}
