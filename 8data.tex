...
\begin{center}
	\begin{tabular}{p{1.1cm} p{1.1cm} p{1.1cm} p{1.1cm} p{1.1cm} p{1.1cm} p{1.1cm} p{1.1cm} p{3cm}}
		...
		\multicolumn{9}{l}{COND = 1 All subsequent tag-recapture entries must be omitted if "Do Tags" = 0} \Tstrut\\
		 ...
		 &   &  \multicolumn{7}{l}{to expected recoveries (0 = release period). Starting in v.3.30.19 a negative}\\
		 &   &  \multicolumn{7}{l}{value can be input to invoke reading of additional parameters for minimum}\\
		 &   &  \multicolumn{7}{l}{and maximum recapture periods.}\Bstrut\\
		 \hline
		 ...
		 \multicolumn{9}{l}{COND = negative mix period} \Tstrut\\
		 &  2 &  \multicolumn{7}{l}{Minimum period for tag recapture. The number of recaptures needs to be }\\
		 &   &  \multicolumn{7}{l}{>= mixperiod must be >= min recap to include tag group in log likelihood}\Bstrut\\
		 \hline
