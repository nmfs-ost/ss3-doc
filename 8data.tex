...
When Lbin\_lo and Lbin\_hi are used to select a subset of the total size range, the expected value for these age data is calculated within that specified size range, so age is conditional on length.
