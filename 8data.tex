...
\begin{center}
	\begin{tabular}{p{1.1cm} p{1.1cm} p{1.1cm} p{1.1cm} p{1.1cm} p{1.1cm} p{1.1cm} p{1.1cm} p{3.5cm}}
		...
		\hline
		1 &  \multicolumn{8}{l}{Do morph composition, if zero, then do not enter any further input below.}\Tstrut\Bstrut\\
		\hline
		...
		\hline
		& Year & Month & Type & Part & Nsamp & \multicolumn{3}{l}{Data Vector} \Tstrut\Bstrut\\
		\hline
