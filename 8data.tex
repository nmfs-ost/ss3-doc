		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\begin{itemize}
				    ...
				    \item 1 = only R0 active in phase 1. Then finish with no other parameters becoming active; useful for data-limited draws of other fixed parameters. Essentially, this option allows SS3 to mimic \gls{dbsra}; and
...
For the normal error structure, the entered values for \gls{se} are interpreted directly as a \gls{se} in arithmetic space and not as a CV. Thus switching from a log-normal to a normal error structure forces the user to provide different values for the \gls{se} input in the data file.
...
\begin{center}
	\begin{tabular}{p{2cm} p{3cm} p{3cm} p{3cm} p{3cm}}
		...
		\hline
		Year & Month & Fleet & Observation & SE \Tstrut\Bstrut\\
		\hline
