...
The number of short parameter lines for each time-varying setup selected depends on the selection options. The auto-generated feature can be used to figure out which parameter lines are needed. The short parameter lines needed for different time-varying options are:
...
\begin{itemize}
	...
	\multicolumn{8}{l}{COND: Only if MG parameters are time-varying} \Tstrut\\
