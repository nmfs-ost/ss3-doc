...
%KD note: I think this is too much detail , but maybe the eqns should be added to the trend info above?
...
%TODO: add a table with descriptions of what each of these time varying short parameters are and whether they are expected to be estimated or fixed?
