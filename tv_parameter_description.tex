...
\begin{longtable}{p{0.6cm} p{0.6cm} p{0.9cm} p{1cm} p{1cm} p{1cm} p{1cm} >{\raggedright\arraybackslash}p{7cm}}
	\hline
...
\begin{itemize}
	...
	\begin{center}
		\begin{longtable}{p{0.6cm} p{0.6cm} p{0.9cm} p{2cm} p{1.3cm} p{2cm} >{\raggedright\arraybackslash\small}p{1.7cm} p{1.6cm} p{2cm}}
			
			\hline
			LO & HI & INIT & <other entries>         & PHASE & <other entries>         & Use\_Block & Block Fxn & Parameter Label \Tstrut\Bstrut\\
			\hline
	...
	\begin{longtable}{p{1cm} p{0.9cm} p{0.9cm} p{1cm} p{1cm} p{1cm} p{1cm} >{\raggedright\arraybackslash\small}p{6.3cm}}
	\hline
	   &    &      & Prior & Prior    & Prior &  & \Tstrut\\
	LO & HI & INIT & Value & \gls{sd} & Type  & Phase & Parameter Label \Bstrut\\
	\hline
