...
Code for the deviation link can be found in \href{https://github.com/nmfs-stock-synthesis/ss3-source-code/blob/main/SS_timevaryparm.tpl}{SS\_timevaryparm.tpl}, search for ``SS\_Label\_Info\_14.3''.
