...
{
    name={log},
    description={refers to the general process of taking a logarithm regardless of base; ln() refers to the specific process of taking the natural logarithm.}
}
...
\newacronym{mg}{MG}{mortality-growth}
