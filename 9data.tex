...
\begin{tabular}{p{2cm} p{2cm} p{2cm} p{2cm} p{2cm} p{2cm} p{2cm} p{2cm}}
		...
		\hline
		\#Min Tail Compression & Constant added to proportions & Combine males \& females & Compress Bins & \hypertarget{Dirichlet}{Error Distribution} & Dirichlet Parameter Number & Min Sample Size\\
		\hline
		0 & 0.0001 & 0 & 0 & 0 & 0 & 1 \\
		0 & 0.0001 & 0 & 0 & 0 & 0 & 1 \\
		\hline
...
\begin{tabular}{p{2cm} p{2cm} p{2cm} p{2cm} p{2cm} p{2cm} p{2cm}}
		...
		\hline
		\#Min Tail Compression & Constant added to proportions & Combine males \& females & Compress Bins & Error Distribution & Dirichlet Parameter Number & Minimum Sample Size\\
		\hline
		0 & 0.0001 & 1 & 0 & 0 & 0 & 1 \\
		0 & 0.0001 & 1 & 0 & 0 & 0 & 1 \\
		0 & 0.0001 & 1 & 0 & 0 & 0 & 1 \\
