...
\begin{description}
	...
	\begin{itemize}
		...
		\item -3 = truncate normal distribution, value of error in data file is interpreted as standard error of the observation.  This is a good option for low observed discard rates.
	\end{itemize}
	\item[Discard notes]\
	\begin{itemize}
